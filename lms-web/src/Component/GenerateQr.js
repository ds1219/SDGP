...
const GenerateQRCode = () => {
  ...
  // console.log("[Qr]" + lectureSessionID);

  const generateQRCode = async () => {
    const qrCodeValue = lectureSessionID;
  ...
  const qrCode = qrValue ? (
    ...
    <div className="empty-qr-code">
      QR code will be generated after entering text
    </div>
  );
  ...
  return (
    <div className=" bg-black h-screen">
      <div className="flex flex-col lg:flex-row items-center justify-center container   ">
        <div
          id="inn"
          className="flex flex-col lg:flex-row justify-center items-center m-12"
        >
