    ...
    <div className="flex flex-col justify-center items-center h-screen bg-black">
     ...
     <form
        ...
        <label className=" block mb-2 text-sm font-medium text-gray-900 dark:text-white ">
          ...
          ></input>
           <p id="warningmail" className=" text-red-600 opacity-0">Invalid</p>    
        </label>
        <label className=" block mb-2 text-sm font-medium text-gray-900 dark:text-white ">
          FirstName
          <input
            ...
            className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ></input>
           <p id="warningfirst" className=" text-red-600 opacity-0">Invalid</p>  
        </label>
        <label className=" block mb-2 text-sm font-medium text-gray-900 dark:text-white ">
          LastName
          <input
       ...
       <label className=" block mb-2 text-sm font-medium text-gray-900 dark:text-white ">
          ...
          >
            ...
            <p id="warningpass" className=" text-red-600 opacity-0">Both Uppercase and LowerCase Letters,Atlease 1 Number</p>  
        </label>
